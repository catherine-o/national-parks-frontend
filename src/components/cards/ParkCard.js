...
export default function ParkCard({park, selectedPark, updateSelectedPark, renderCards, selectedState, addParkToBucketlist, removeParkFromBucketlist, bucketlist, memoir, addParkToMemoir, removeParkFromMemoir}) {
